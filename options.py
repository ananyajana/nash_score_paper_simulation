...
class Options:
    def __init__(self, isTrain):
        ...
        self.train['data_dir'] = '/dresden/users/aj611/experiments/biomed/he_images/' # path to data
        ...
        self.train['epochs'] = 3         # number of slide-level training epochs
        ...
        self.train['log_interval'] = 500 # iterations to print training results
